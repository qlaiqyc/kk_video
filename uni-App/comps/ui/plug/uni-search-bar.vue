<template>
	<view class="uni-searchbar" :style="{backgroundColor: contentColor}">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor,borderColor:borderColor}" class="uni-searchbar__box" @click="searchClick">
			<!-- #ifdef MP-ALIPAY -->
